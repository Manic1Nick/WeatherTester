...
import ua.nick.weather.model.openWeather.OpenWeatherForecast;
import ua.nick.weather.model.wunderground.wForecast.Forecastday_;
import ua.nick.weather.model.wunderground.wForecast.WundergroundForecast;
...
public class ForecastFactory {
    ...
    public List<Forecast> createListForecastModelsFromJson(Provider provider, String json)
        ...
        if (provider == Provider.OPENWEATHER) {
            ...
            List<ua.nick.weather.model.openWeather.List> forecastsList = openWeather.getList();
            for (ua.nick.weather.model.openWeather.List list : forecastsList) {
